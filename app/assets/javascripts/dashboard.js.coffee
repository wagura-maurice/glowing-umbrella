...
dashReady = ->
  ...
  popCropTable = (data) =>
    ...
    for key, value of data
      ...
      c.innerHTML = value.total_bags_harvested
      totalBagsHarvested += value.total_bags_harvested
      e = document.createElement('td')
      e.innerHTML = value.aggregated_produce
      totalAggregatedProduce += value.aggregated_produce
      f = document.createElement('td')
      f.innerHTML = value.produce_collected
    ...
    b1.innerHTML = totalKgSeedPlanted
    c1 = document.createElement('td')
    c1.innerHTML = totalBagsHarvested
    d1 = document.createElement('td')
    d1.innerHTML = totalAggregatedProduce
    e1 = document.createElement('td')
    e1.innerHTML = totalProduceCollected
