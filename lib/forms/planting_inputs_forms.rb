module PlantingInputsForms
  ...
  def maize_report
    {
      ...
      questions: {
        ...
        2 => {
          question_text: "Which type of planting fertilizer do you what? \n1. D.A.P \n2. N.P.K (23:23:0)",
          valid_responses: ["1", "2"],
          save_key: :type_of_planting_fertilizer,
          next_question: {"1" => 3, "2" => 4},
          error_message: "You're response was not valid. Which type of planting fertilizer do you what? \n1. D.A.P \n2. N.P.K (23:23:0)"
        },
        3 => {
          question_text: "How many bags of 50KG D.A.P planting fertilizer do you what?",
          valid_responses: :any_number,
          save_key: :bags_of_dap_fertilizer,
          next_question: 5,
          error_message: "You're response was not valid. How many bags of 50KG D.A.P planting fertilizer do you what?"
        },
        4 => {
          question_text: "How many bags of 50KG NPK (23:23:0) planting fertilizer do you what?",
          valid_responses: :any_number,
          save_key: :bags_of_npk_fertilizer,
          next_question: 5,
          error_message: "You're response was not valid. How many bags of 50KG NPK (23:23:0) planting fertilizer do you what?"
        },
        5 => {
          question_text: "How many bags of 50KG C.A.N top dressing fertilizer do you what?",
          valid_responses: :any_number,
          save_key: :bags_of_can_fertilizer,
          next_question: 6,
          error_message: "You're response was not valid. How many bags of 50KG C.A.N top dressing fertilizer do you what?"
        },
        6 => {
  ...
  def get_inputs_menu_text
    ...
    ret = "What do you want to plant this season? "
    can_report = {}
